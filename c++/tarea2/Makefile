...
ENTREGAR = cliente producto  carritoProductos clientesABB clientesSucursalesLDE 

MODULOS = $(ENTREGAR) fecha utils
...
IDS_PUBLICOS = producto1-crear-liberar \
			   ...
			   clientesSucursalesLDE4-removerultimo-removerenesimo \
